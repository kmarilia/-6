def fibonacci_search(arr, x):
    ...
    fib_m2 = 0  # (m-2)e число Фибоначчи
    fib_m1 = 1  # (m-1)e число Фибоначчи
    fib_m = fib_m2 + fib_m1
    ...
    while fib_m > 1:
        ...
        # Если х больше элемента, переходим к правому подмассиву
        if arr[i] < x:
            fib_m = fib_m1
            fib_m1 = fib_m2
            fib_m2 = fib_m - fib_m1
            offset = i
        # Если х меньше элемента, переходим к левому подмассиву
        elif arr[i] > x:
            fib_m = fib_m2
